        ...
        <section className='flex flex-col md:flex-row'>
            <div className='h-100 md:w-1/2 text-white '
                ...
                <div className='h-full w-full px-6  sm:px-12 lg:px-24 pt-16 sm:pt-24 pb-[48px]' style={{
                    ...
                    <p className='mt-6 text-xs sm:text-base text-center md:text-start'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua ut enim.</p>
                </div>
            </div>

            <div className='bg-[#1C1E53] px-6  sm:px-12 lg:px-24 pt-16 sm:pt-24 pb-[48px] text-white md:w-1/2'>
                <h3 className='text-3xl font-medium text-center md:text-start'>Send inquiry</h3>
                <p className='text-xs sm:text-base font-medium mt-4 mb-10 text-center md:text-start'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore.</p>
                <form action="">
